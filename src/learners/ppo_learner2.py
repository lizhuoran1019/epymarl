...
class PPOLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        with th.no_grad():
            ...
            old_values = self.critic.forward(batch)  # shape: (batch_size, seq_length, n_agents, 1)
            ...
            if self.args.common_reward:
                ...
                rewards = rewards.unsqueeze(2).repeat(1, 1, self.n_agents, 1)
            advantages, targets = build_gae_targets(rewards, mask_agent, values, self.args.gamma, self.args.gae_lambda)
        ...
        for _ in range(self.args.epochs):
            ...
            values = self.critic.forward(batch)[:, :-1]  # shape: (batch_size, seq_length-1, n_agents, 1)
            ...
            loss = actor_loss + self.args.critic_coef * critic_loss - self.args.entropy_coef * entropy_loss / entropy_loss.item()
